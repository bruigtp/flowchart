...
## View flowchart elements

Function to return \$data or \$fc

- [`fc_view()`](https://bruigtp.github.io/flowchart/reference/fc_view.md)
  : fc_view

## S3 methods for class ‘fc’

Implemented S3 methods (print, summary, plot) for objects of class ‘fc’

- [`print(`*`<fc>`*`)`](https://bruigtp.github.io/flowchart/reference/print.fc.md)
  : print.fc
- [`summary(`*`<fc>`*`)`](https://bruigtp.github.io/flowchart/reference/summary.fc.md)
  : summary.fc
- [`plot(`*`<fc>`*`)`](https://bruigtp.github.io/flowchart/reference/plot.fc.md)
  : plot.fc
...
- [`safo`](https://bruigtp.github.io/flowchart/reference/safo.md) :
