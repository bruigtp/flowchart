...
We can also add titles to each step of a flowchart to create [CONSORT](https://www.equator-network.org/reporting-guidelines/consort/)-style flow diagrams. The argument `title` must be used in the `as_fc()`, `fc_filter()` or `fc_split()` functions: 
